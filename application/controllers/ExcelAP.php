...
Class ExcelAP extends CI_Controller{
    ...
    function cetakAP(){
        ...
        $object->getActiveSheet()->getStyle("A1:CL1")->applyFromArray(
                array(
                    'fill' => array(
        ...
        $table_columns = array(
            ...
            //23 & 4
            "Name AGEN" ,"Invoice No. AGEN" ,"Invoice AGEN date" ,"Tgl Terima Invoice" ,"Invoice AGEN Amount" ,"Payment amount AGEN" ,"Payment Date AGEN" , "Invoice No. GENSET" , "Invoice GENSET date" , "Tgl Terima Invoice" , "Invoice GENSET Amount" , "Payment GENSET" , "Payment Date GENSET" , "Invoice No. BJTI" , "Invoice BJTI date" , "Tgl Terima Invoice" , "Invoice BJTI Amount" , "Payment BJTI" , "Payment Date BJTI" , "Name SHIP" , "Invoice No. SHIP" , "Invoice SHIP date" , "Tgl Terima Invoice" , "Invoice SHIP Amount" , "Payment SHIP" , "Payment Date SHIP" , "Invoice No. THC" , "Invoice THC date" , "Tgl Terima Invoice" , "Invoice THC Amount" , "Payment THC" , "Payment Date THC" , "Invoice No. PLUG" , "Invoice PLUG date" , "Tgl Terima Invoice" , "Invoice PLUG Amount" , "Payment PLUG" , "Payment Date PLUG" , "Tanggal Kirim Dokumen ke AR" , "Invoice No. Buruh" , "Invoice Buruh date" , "Tgl Terima Invoice" , "Invoice Buruh Amount" , "Payment Buruh" , "Payment Date Buruh" , "No. Invoice Shipment ULI HUB 1" , "Tgl Invoice Shipment ULI HUB 1" , "Tgl Terima Invoice" , "Invoice Shipment ULI HUB 1 Amount" , "Payment Shipment ULI HUB 1" , "Payment Date Shipment ULI HUB 1" , "No. Invoice Shipment ULI HUB 2" , "Tgl Invoice Shipment ULI HUB 2" , "Tgl Terima Invoice" , "Payment Date Shipment ULI HUB 2 Amount" , "Payment Shipment ULI HUB 2" , "Payment Date Shipment ULI HUB 2" , "Invoice No. LAIN" , "Invoice LAIN date" , "Tgl Terima Invoice" , "Invoice LAIN Amount" , "Payment LAIN" , "Payment Date LAIN"
            );
        $column = 0;
        ...
        foreach($AllData as $row)
        {
            ...
            $object->getActiveSheet()->setCellValueByColumnAndRow(65, $excel_row, $row->tgl_kirim_dok_ar);
