...
// SELECT op.no_transaksi, op.IMO, op.no_container, op.name_cust, op.no_shipment, op.no_shipment2, op.no_seal, op.full_empty, op.reefer_dry, op.stuff_date, op.in_out, op.origin_town, op.dest_town, op.vessel_name, op.deliv_date, op.arv_at_dest, op.remark_op, op.tgl_door, op.no_ship_uli, op.tuj_ship_uli, op.tgl_door_uli, op.no_ship_uli2, op.tuj_ship_uli2, op.tgl_door_uli2, op_in.* FROM op LEFT JOIN op_in ON op.no_transaksi = op_in.no_transaksi_in
