                            ...
                            <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="background-color: plum">Nomor B/L</th>
                                        <th style="background-color: plum">Pembayaran</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <td style="background-color: plum"><?php echo $ap->no_bl ?></td>
                                        <td style="background-color: plum"><?php echo $ap->no_pem ?></td>
                                        <td>
